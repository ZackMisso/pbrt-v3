...
void ExperimentFlags::initialize_globe_test()
{
    ...
    ext_calls.push_back(16055417 * 6);
    ext_calls.push_back(28745021 * 6);
    ext_calls.push_back(44924520 * 5);
    ext_calls.push_back(77719541 * 5);
    ext_calls.push_back(160525061 * 5);
...
void ExperimentBase::initializeSampler(std::string sampler,
                                       int pixelSamples)
{
...
void ExperimentBase::initializeFilm(std::string output,
                                    int xres,
                                    int yres)
{
...
void ExperimentBase::initializeFilm(std::vector<Float> crop,
                                    std::string output,
                                    Float scle,
                                    int xres,
                                    int yres)
...
void ExperimentBase::initializeCamera(std::string camera,
                                      Float fov_val)
{
                                             ...
                                             std::string nFile)
{
    ...
    initializeShapeParamSet(paramSet,
                            indices,
                            sts,
                            ps,
                            ns);
...
void ExperimentBase::initializeVDBMedium(std::string name,
                                         std::string medType,
                                         std::string trans,
                                         std::string maj,
                                         std::string min,
                                         ...
                                         bool m_worldSpace,
                                         bool m_clampDensities,
                                         bool m_retargetDensities,
...
void ExperimentBase::initializeGridMedium(std::string name,
                                          std::string medType,
                                          std::string trans,
                                          std::string maj,
                                          std::string min,
...
void ExperimentBase::initializeMedium(std::string name,
                                      std::string medType,
                                      std::string dense,
                                      std::string trans,
                                      std::string maj,
...
void ExperimentBase::initializeProceduralMedium(std::string name,
                                                std::string medType,
                                                std::string texName,
                                                std::string trans,
                                                std::string maj,
...
void ExperimentBase::initializeMaterial_Matte(std::string tex_kd,
                                              Float sig)
{
    std::unique_ptr<Float[]> sigma(new Float[1]);
    sigma[0] = sig;
...
void ExperimentBase::initializeNamedMaterial_Substrate(std::string name,
                                                       std::vector<Float> ks,
                                                       std::string tex_kd,
                                                       Float u_rough,
                                                       Float v_rough,
...
void ExperimentBase::initializeTextureImg(std::string name,
                                          std::string type,
                                          std::string texname,
...
void ExperimentBase::initializeNamedMaterial_Uber(std::string name,
                                                  std::vector<Float> ks,
                                                  std::vector<Float> kd,
...
void ExperimentBase::initializeScaleTexture(std::string name,
                                            std::string type,
                                            std::string texname,
...
void ExperimentBase::initializeNamedMaterial(std::string name,
                                             Float rough,
                                             Float ind,
                                             std::string typ,
                                             std::vector<Float> kd,
...
void ExperimentBase::initializeGlass(std::string r,
                                     std::string t,
                                     Float ind)
{
    std::unique_ptr<Float[]> index(new Float[1]);
...
void ExperimentBase::initializeGlass(std::vector<Float> r,
                                     std::vector<Float> t,
                                     Float ind)
{
    std::unique_ptr<Float[]> Kt(new Float[3]);
...
void ExperimentBase::initializeVoronoiSpiralTexture(std::string name,
                                                    ...
                                                    int t_levelPoints)
{
    ...
    textureParams.AddRGBSpectrum("levelColors", std::move(levelColors), t_levelColors.size());
    textureParams.AddRGBSpectrum("noiseAmp", std::move(noiseAmp), 3);
    textureParams.AddRGBSpectrum("noisePeriod", std::move(noisePeriod), 3);
    textureParams.AddFloat("amplitudes", std::move(amplitudes), t_amplitudes.size());
                                                ...
                                                std::vector<Float> t_maxB)
{
    ...
    {
        locations[i] = Point3f(points[i*3], points[i*3+1], points[i*3+2]);
    }
    ...
    textureParams.AddRGBSpectrum("densities", std::move(colors), densities.size());
    textureParams.AddPoint3f("locations", std::move(locations), points.size()/3);
    textureParams.AddPoint3f("minBounds", std::move(minBounds), 1);
    textureParams.AddPoint3f("maxBounds", std::move(maxBounds), 1);
...
void ExperimentBase::initializeDeintegratedTextureMedium(std::string name,
                                                         std::string file,
                                                         std::vector<Float> t_minB,
                                                         std::vector<Float> t_maxB,
                                                         bool t_along_z)
...
void ExperimentBase::initializeCloudTexture(std::string name,
                                            Float t_period,
                                            Float t_resolution,
...
void ExperimentBase::initializeBoxShape(Float minx, Float maxx,
